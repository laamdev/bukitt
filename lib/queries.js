...
export const individualAdventureQuery = groq`
{
  ...
  "moreAdventures": *[_type == "adventure" && slug.current != $slug] | order(title desc, _updatedAt desc) [0...2] {
    ${adventureFields}
  }
}`;
...
export const individualDestinationQuery = groq`
{
  ...
  "moreDestinations": *[_type == "destination" && slug.current != $slug] | order(title desc, _updatedAt desc) [0...2] {
    ${destinationFields}
  }
}`;
