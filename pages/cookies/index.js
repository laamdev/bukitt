    ...
    <div className="space-y-12">
      ...
      <div className="space-y-6">
        ...
        <ul className="space-y-6">
          <li className="space-y-2">
            <h3 className="font-bold">Email newsletters related cookies</h3>
            <p>
          ...
          <li className="space-y-2">
            <h3 className="font-bold">Orders processing related cookies</h3>
            <p>
          ...
          <li className="space-y-2">
            <h3 className="font-bold">Forms related cookies</h3>
            <p>
      ...
      <div className="space-y-6">
        ...
        <p>
          ...
          these to work the following social media sites including; Instagran,
          Facebook, and Twitter, will set cookies through our site which may be
      ...
      <p>
        <span className="font-bold">Email:</span> it@bukitt.com
      </p>
    </div>
  );
}
